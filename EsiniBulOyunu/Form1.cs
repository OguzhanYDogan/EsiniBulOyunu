namespace EsiniBulOyunu
{
    public partial class Form1 : Form
    {
        ...
        private void KartlariDiz()
        {
            ...
            for (int y = 0; y < boyut; y++)
            {
                for (int x = 0; x < boyut; x++)
                {
                    ...
                    resimKutusu.Left = x * (resimKutusu.Width + bosluk); // Her eleman geldiðinde saða doðru 100 px ilerlemiþ oluyor
                    resimKutusu.Top = y * (resimKutusu.Height + bosluk); // Her y döngüsü tamamlandýðýnda da aþaðý doðru 100 px ilerlemiþ olur
        ...
        private void ResimKutusu_Click(object? sender, EventArgs e)
        {
            ...
            // eðer ayný karta 2. kez týklandýðýnda bir þey yapmadan çýk
